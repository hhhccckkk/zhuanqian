 ...
 * {@link HCKHttpClient}. The {@link #onSuccess(String)} method is 
 ...
 * </pre>
 */
public class HCKHttpResponseHandler {
     ...
     */
    public HCKHttpResponseHandler() {
        // Set up a handler to post events back to the correct thread if possible
        if(Looper.myLooper() != null) {
            handler = new Handler(){
                @Override
                public void handleMessage(Message msg){
                    HCKHttpResponseHandler.this.handleMessage(msg);
                }
            };
        }
    }
