 ...
 * {@link HCKHttpResponseHandler} instance.
 * <p>
 * For example:
 * <p>
 * <pre>
...
public class HCKHttpClient {
   ...
   /**
     ...
     */
    public void get(String url, HCKHttpResponseHandler responseHandler) {
    	this.url=url;
    	String urlString=url;
    	urlString=urlString+"&password=HCK123hck";
        get(null, urlString, null, responseHandler);
    }
     ...
     * @param responseHandler the response handler instance that should handle the response.
     */
    public void get(String url, RequestParams params, HCKHttpResponseHandler responseHandler) {
    	this.params=params;
    	this.url=url;
    	params.put("password", "HCK123hck");
        get(null, url, this.params, responseHandler);
    }
     ...
     * @param responseHandler the response handler instance that should handle the response.
     */
    public void get(Context context, String url, HCKHttpResponseHandler responseHandler) {
    	String urlString=url;
    	urlString=urlString+"&password=HCK123hck";
     ...
     * @param responseHandler the response handler instance that should handle the response.
     */
    public void get(Context context, String url, RequestParams params, HCKHttpResponseHandler responseHandler) {
     ...
     *        the response.
     */
    public void get(Context context, String url, Header[] headers, RequestParams params, HCKHttpResponseHandler responseHandler) {
     ...
     * @param responseHandler the response handler instance that should handle the response.
     */
    public void post(String url, HCKHttpResponseHandler responseHandler) {
     ...
     * @param responseHandler the response handler instance that should handle the response.
     */
    public void post(String url, RequestParams params, HCKHttpResponseHandler responseHandler) {
     ...
     * @param responseHandler the response handler instance that should handle the response.
     */
    public void post(Context context, String url, RequestParams params, HCKHttpResponseHandler responseHandler) {
     ...
     * @param responseHandler the response handler instance that should handle the response.
     */
    public void post(Context context, String url, HttpEntity entity, String contentType, HCKHttpResponseHandler responseHandler) {
    ...
    public void post(Context context, String url, Header[] headers, RequestParams params, String contentType,
            HCKHttpResponseHandler responseHandler) {
     ...
     * @param responseHandler the response handler instance that should handle the response.
     */
    public void put(String url, HCKHttpResponseHandler responseHandler) {
     ...
     * @param responseHandler the response handler instance that should handle the response.
     */
    public void put(String url, RequestParams params, HCKHttpResponseHandler responseHandler) {
     ...
     * @param responseHandler the response handler instance that should handle the response.
     */
    public void put(Context context, String url, RequestParams params, HCKHttpResponseHandler responseHandler) {
     ...
     * @param responseHandler the response handler instance that should handle the response.
     */
    public void put(Context context, String url, HttpEntity entity, String contentType, HCKHttpResponseHandler responseHandler) {
     ...
     * @param responseHandler the response handler instance that should handle the response.
     */
    public void put(Context context, String url,Header[] headers, HttpEntity entity, String contentType, HCKHttpResponseHandler responseHandler) {
     ...
     * @param responseHandler the response handler instance that should handle the response.
     */
    public void delete(String url, HCKHttpResponseHandler responseHandler) {
     ...
     * @param responseHandler the response handler instance that should handle the response.
     */
    public void delete(Context context, String url, HCKHttpResponseHandler responseHandler) {
     ...
     * @param responseHandler the response handler instance that should handle the response.
     */
    public void delete(Context context, String url, Header[] headers, HCKHttpResponseHandler responseHandler) {
        final HttpDelete delete = new HttpDelete(url);
    ...
    // Private stuff
    protected void sendRequest(DefaultHttpClient client, HttpContext httpContext, HttpUriRequest uriRequest, String contentType, HCKHttpResponseHandler responseHandler, Context context) {
        if(contentType != null) {
            uriRequest.addHeader("Content-Type", contentType);
        }

        Future<?> request = threadPool.submit(new HCKHttpRequest(client, httpContext, uriRequest, responseHandler,url));
